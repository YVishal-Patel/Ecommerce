  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z" />
      ...
      <div className="container d-flex justify-content-center  mt-3 d-flex w-100">
        <ul className="d-flex justify-content-center">
          <li className='list'><Link className='header-data'  to='#'> <small className='flex-nowrap'> New Arrival </small> </Link></li>
      ...
      {/* <div className="container-fluid header-div">
        <div className="container">
          <div className="d-flex justify-content-between main-header-data">
          <div className="logo">
            <div className="main-logo">Brain Inventory</div>
          </div>
