        ...
        let newArr = [
            ...
            {id:7, ProductName:"Women Kurta and Palazzo", ProductPrice: 299, ProductDescription:"Some quick example text to build on the card title and make up the bulk of the card's content.", quantity:1,ProductImg:img4},

            {id:8, ProductName:"Women Kurta and Palazzo", ProductPrice: 299, ProductDescription:"Some quick example text to build on the card title and make up the bulk of the card's content.", quantity:1, ProductImg:img},

            {id:9, ProductName:"Women Kurta and Palazzo", ProductPrice: 299, ProductDescription:"Some quick example text to build on the card title and make up the bulk of the card's content." , quantity:1, ProductImg:img4},

            {id:10, ProductName:"Women Kurta and Palazzo", ProductPrice: 299, ProductDescription:"Some quick example text to build on the card title and make up the bulk of the card's content.", quantity:1 ,ProductImg:img}]
